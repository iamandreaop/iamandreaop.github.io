// ============================================================
// BIO — Edit the values below to update your About section
// ============================================================
window.SITE_CONTENT = window.SITE_CONTENT || {};
window.SITE_CONTENT.bio = {
  "headline": "Untangling complexity to find a path forward.",
  "intro": "Hello, I'm Andrea Ong, a strategist, designer, and coach.",
  "body": [
    ...
    "Outside of design, I'm a watercolour artist, dinghy sailor, <a href=\"https://andreaong.ca/scubagirl.github.io/\" target=\"_blank\" rel=\"noopener\" style=\"text-decoration:underline;text-underline-offset:3px;color:inherit;\">underwater photographer</a>, and a mom to two fluffy cats."
  ],
